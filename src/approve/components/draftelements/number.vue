<template>
    <div class="number-wrapper clearFix">
        ...
        <div class="number fl">
            <!-- <input type="tel" class="numberInp" :placeholder="placeholder" v-model.trim="inputNum"
                                   @input="saveNumberData"  maxlength="20"> -->
            <input type="text" class="numberInp" :placeholder="placeholder" v-model.trim="inputNum"
                   @input="saveNumberData"  maxlength="20">
        </div>
